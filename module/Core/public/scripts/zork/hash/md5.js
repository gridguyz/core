...
( function ( global, $, js )
{
    ...
    if ( typeof js.hash.md5 !== "undefined" )
    {
        return;
    }
    ...
    var utf8_encode = function ( argString )
    {
        ...
        for ( n = 0; n < stringl; n++ )
        {
            ...
            {
                enc = String.fromCharCode( ( c1 >> 6 ) | 192 ) + String.
                    fromCharCode( ( c1 & 63 ) | 128 );
            }
            else
            {
                enc = String.fromCharCode( ( c1 >> 12 ) | 224 ) + String.
                    fromCharCode( ( ( c1 >> 6 ) & 63 ) | 128 ) + String.
                    fromCharCode( ( c1 & 63 ) | 128 );
            }
     ...
     * @type String
     */
    global.Zork.Hash.prototype.md5 = function ( str )
    {
        // http://kevin.vanzonneveld.net
        // +   original by: Webtoolkit.info (http://www.webtoolkit.info/)
        ...
        var _F = function ( x, y, z )
            ...
            {
                a = addUnsigned( a, addUnsigned( addUnsigned(
                    _F( b, c, d ), x ), ac ) );
        ...
        return ( wordToHex( a ) + wordToHex( b ) +
            wordToHex( c ) + wordToHex( d ) ).toLowerCase();
    };

    global.Zork.Hash.prototype.md5.modulePrefix = [ "zork", "hash", "md5" ];
    global.Zork.Hash.prototype.md5.encode = global.Zork.Hash.prototype.md5;
